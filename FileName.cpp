...
bool battle(int& playerHealth, int enemyDifficulty, const string& enemyType) {
    int enemyHealth = rand() % 51 + 50 * enemyDifficulty;
...
void Storyline(int& playerExperience, int questChoice) {
    if (questChoice == 1) {
        ...
        cout << "\nYou engage in an medium quest to face Orcs." << endl;
        playerExperience += 50;
    }
